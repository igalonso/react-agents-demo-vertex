...
def recruiter_email_creator(candidate_summary: str, full_name: str, company_name: str, position: str, verbose: bool) -> None:
    task = f"You are a recruiter called Codi Palmer that likes to be super descriptive and detailed when you write emails. I want you to write a draft email to {full_name} to offer a new job in our company {company_name} and ask for an interview. The job position offered to {full_name} is {position}. You MUST include information about the hiring company in the email. You MUST incude a explicit mention of, at least, two of the companies the candidate has worked for. YOU MUST include EXPLICITLY the salary offered in the email. You MUST use the information provided in here: \n{candidate_summary}\n"
    print(task)
