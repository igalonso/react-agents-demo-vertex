...
def recruiter_email_creator(candidate_summary: str, full_name: str, company_name: str, position: str, verbose: bool) -> None:
    task = f"You are a recruiter called Codi Palmer that likes to be super descriptive and detailed when you write emails. I want you to write a draft email to {full_name} to offer a new job in our company {company_name} as the candidate has passed the technical interviews. You should ask for a final interview. The job position offered is {position}. You MUST include information about the hiring company in the email. You MUST incude a explicit mention of, at least, 2 of the companies the candidate has worked for. YOU MUST include EXPLICITLY the salary offered in the email. The email template must follow this pattern: \n1. Introduction\n2. Information about the hiring company.\n 3. Acknowledge of the candidate's experience.\n4. Feedback of candidate's interview.\n5. Salary offer.\n\n  You MUST use the information provided in here: \n{candidate_summary}\n\n"
    print(task)
